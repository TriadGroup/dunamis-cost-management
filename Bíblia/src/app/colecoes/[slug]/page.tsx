...
import { getCollectionBySlug } from "@/lib/demo/repository";
  ...
  return (
    <div className="space-y-6">
      <Card className="space-y-5">
        <SectionHeading eyebrow="Coleção" title={collection.title} description={collection.description} />
        <div className="flex flex-wrap gap-2">
          {collection.featuredRefs.map((reference) => (
      ...
      <div className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <Card className="space-y-4">
          <SectionHeading title="Entradas destacadas" />
          <div className="space-y-3">
            {collection.featuredEntries.map((entry) => (
        ...
        <Card className="space-y-4">
          <SectionHeading title="Autores da coleção" />
          <div className="space-y-3">
